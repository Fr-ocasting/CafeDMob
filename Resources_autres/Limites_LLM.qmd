# Début du café avec un Kahoot, n'apparait pas dans les slides 
1. Kahoot (WookLap) - question au début :
    ...
    8. Lorsqu'une IA répond, a quel point vous faites confiance à l'IA ? 
       1. Simulation: vous êtes dans un contexte pro, vous devez vérifier une information concernant un ....
       2. Simulation: vous êtes dans un contexte perso, vous voulez vérifier une annecdote ....
       3. Slide pour quantifier la confiance (0-100%)
...
3. Loi d'échelle : 
   ...
   - Quels coût écologique (eau, CO2, terre rare ...)
     - Augmentation de la demande en électricité dans le monde: d'après un rapport de l'[International Energy Agency (IEA), 2024](https://www.iea.org/reports/world-energy-outlook-2024), de 2023 à 2030 elle devrait augmenter de 6750 TWh, soit l'équivalent de plus de la demande d'électricité de l'UE et US combiné en 2023. L'augmentation de la demande relative au Data Center correspond à celle de la désanilisation, et moins d'un tiers de celle des véhicules électriques ou du refroidissement dans le secteur immobiliers.
     - Ce chiffre concerne à décénie à venir uniquement.
     - STEPS: **ST**at**E**d **P**olicies **S**cenario: scénario de référence, qui suppose que les politiques actuelles sont maintenues, et que les engagements pris sont respectés.
  ![Augmentation de la demande d'électricité dans le monde](plot/electricity_demand_IEA.png)

1. Problème et question de société :
...
#### Taille de contexte et token de sortie LLMs:
  ...
  - [source](https://epoch.ai/data-insights/output-length/)
